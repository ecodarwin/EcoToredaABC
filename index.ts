...
const init = async () => {
  const client = await createAuth0Client({
    clientId: 'vML7N2BSQxMKj2C9ACn8gd35scAsAkM3', //cleintID from auth0
    domain: 'dev-l3mthvmhdist73eo.us.auth0.com/',//domain from auth0
    authorizationParams: {
      redirect_uri: 'www.ecotoreda.com/marketplace/dashboard', //Redirect URL after login
    },
  });
